...
CREATE TABLE `estimation_procedure` (
  ...
  `type` enum('crossvalidation','leaveoneout','holdout','holdout_ordered','bootstrapping','subsampling','testthentrain','holdoutunlabeled','customholdout','testontrainingdata') NOT NULL,
