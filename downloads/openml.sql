...
--
-- Host: localhost
-- Generation Time: Jun 16, 2017 at 02:32 PM
...
--
ALTER TABLE `file`
  MODIFY `id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5789610;
--
...
--
ALTER TABLE `users_groups`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3418;
--
