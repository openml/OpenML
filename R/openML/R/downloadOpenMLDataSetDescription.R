...
parseOpenMLDataSetDescription = function(file) {
  ...
  args[["creator"]] = xmlRValS(doc, "/oml:data_set_description/oml:creator")
  args[["contributor"]] = xmlValsMultNsS(doc, "/oml:data_set_description/oml:contributor")
  args[["description"]] = xmlRValI(doc, "/oml:data_set_description/oml:description")
  args[["language"]] = xmlRValI(doc, "/oml:data_set_description/oml:language")
  args[["format"]] = xmlRValI(doc, "/oml:data_set_description/oml:format")
  args[["licence"]] = xmlRValI(doc, "/oml:data_set_description/oml:licence")
    # FIXME: will there be a date?, yes autogenerated by db
  args[["upload.date"]] = xmlRValD(doc, "/oml:data_set_description/oml:licence")
  args[["collection.date"]] = xmlRValD(doc, "/oml:data_set_description/oml:licence")
  ...
  args[["md5.checksum"]] = xmlRValI(doc, "/oml:data_set_description/oml:md5_checksum")
