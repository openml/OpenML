...
public class PartitionerConfiguration {
    ...
    void save(final NodeSettingsWO settings) {
        settings.addInt("repeat", m_repeat);
        settings.addInt("fold", m_fold);
    }
    ...
    void load(final NodeSettingsRO settings) {
        m_repeat = settings.getInt("repeat", 0);
        m_fold = settings.getInt("fold", 0);
    }
    ...
    void loadAndValidate(final NodeSettingsRO settings)
        ...
        m_repeat = settings.getInt("repeat");
        m_fold = settings.getInt("fold");
    }
