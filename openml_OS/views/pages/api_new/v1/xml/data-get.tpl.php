<oml:data_set_description xmlns:oml="http://openml.org/openml">
  ...
  <?php if (is_array($creator)) foreach ($creator as $c) : ?>
  <oml:uploader><?php echo htmlspecialchars($c); ?></oml:uploader>
  <?php endforeach; ?>
  ...
  <?php if (False and $minio_url != null): ?><oml:minio_url><?php echo htmlspecialchars($minio_url); ?></oml:minio_url><?php endif; ?>
