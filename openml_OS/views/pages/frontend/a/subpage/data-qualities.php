<?php if(false !== strpos($_SERVER['REQUEST_URI'], '/a/data-qualities/')){ ?>
	...
	<ul class="hotlinks">
		<li><a href="https://github.com/openml/EvaluationEngine/tree/master/src/main/java/org/openml/webapplication/fantail/dc"><i class="fa fa-gears"></i> View code</a></li>
	</ul>
