<div class="container-fluid topborder endless guidecontainer openmlsectioninfo">
  <div class="col-xs-12 col-md-10 col-md-offset-1 guidesection" id="mainpanel">
    ...
    @article{OpenML2013,<br>
     author = {Vanschoren, Joaquin and van Rijn, Jan N. and Bischl, Bernd and Torgo, Luis},<br>
     title = {OpenML: Networked Science in Machine Learning},<br>
     journal = {SIGKDD Explorations},<br>
     volume = {15},<br>
     number = {2},<br>
     year = {2013},<br>
     pages = {49--60},<br>
     url = {http://doi.acm.org/10.1145/2641190.2641198},<br>
     doi = {10.1145/2641190.2641198},<br>
     publisher = {ACM},<br>
    ...
    @article{OpenMLR2017,<br>
     author = {Casalicchio, Giuseppe and Bossek, Jakob and Lang, Michel and Kirchhoff, Dominik and Kerschke, Pascal and Hofner, Benjamin and Seibold, Heidi and Vanschoren, Joaquin and Bischl,Bernd},<br>
     title = {OpenML: An R package to connect to the machine learning platform OpenML},<br>
     journal = {Computational Statistics},<br>
     volume = {32},<br>
     number = {3},<br>
     year = {2017},<br>
     pages = {1--15},<br>
     url = {http://doi.acm.org/10.1007/s00180-017-0742-2},<br>
     doi = {10.1007/s00180-017-0742-2},<br>
