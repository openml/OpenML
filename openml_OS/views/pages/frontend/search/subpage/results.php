...
$att = addToGET(array( 'table' => '1', 'listids' => false, 'size' => $this->results['hits']['total']['value']));
...
$att = addToGET(array( 'listids' => '1', 'table' => false, 'size' => $this->results['hits']['total']['value']));
...
<div class="searchstats"><?php echo $this->results['hits']['total']['value'];?> results</div>
...
<?php
if( $this->results != false and $this->results['hits']['total']['value'] > 0){ ?>
      <?php
      if($this->listids){?>
      <!-- copy id list -->
...
<?php if(!$this->table and $this->results['hits']['total']['value']/50>1){ ?>
<ul class="pagination" style="display:none;">
  <li><a href="<?php echo $_SERVER['PHP_SELF'] . "?" . addToGET(array( 'from' => 0)); ?>" style="color:#666">Jump back to page</a></li>
<?php for ($x=0; $x<min($this->from+(10*$this->size),$this->results['hits']['total']['value']); $x+=$this->size) { ?>
