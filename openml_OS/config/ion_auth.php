 ...
 */
$config['hash_method']    = 'md5';	// IMPORTANT: Make sure this is set to either sha1, md5 or bcrypt
 ...
 */
$config['site_title']                 = "OpenML.org";        // Site Title, example.com
$config['admin_email']                = EMAIL_FROM; 		 // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'username';          // A database column which is used to login with
$config['min_password_length']        = 8;                   // Minimum Required Length of Password
$config['max_password_length']        = 256;                  // Maximum Allowed Length of Password
...
$config['forgot_password_expiration'] = 3600;                // The number of miliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
