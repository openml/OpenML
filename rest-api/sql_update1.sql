...
ALTER TABLE `dataset` ADD `author` VARCHAR( 255 ) NULL DEFAULT NULL AFTER `source` ;
ALTER TABLE `dataset` ADD `row_id_attribute` VARCHAR( 255 ) NULL DEFAULT NULL AFTER `classIndex`;
ALTER TABLE `dataset` ADD `md5_checksum` VARCHAR( 255 ) NULL DEFAULT NULL ;
