 ...
 */
public class OpenmlSetupModePanel extends JPanel {
	...
	protected OpenmlSimpleSetupPanel m_simplePanel = new OpenmlSimpleSetupPanel();

	/** The advanced setup panel */
	protected OpenmlSetupPanel m_advancedPanel = new OpenmlSetupPanel();
	...
	public Experiment getExperiment() {
		...
		if (m_SimpleSetupRBut.isSelected())
			return m_simplePanel.getExperiment();
		else
