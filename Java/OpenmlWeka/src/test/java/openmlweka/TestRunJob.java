...
public class TestRunJob {
	...
	public void testApiRunUpload() throws Exception {
		...
		String[] args = {"-task_id", "1", "-config", "server=https://test.openml.org/; avoid_duplicate_runs=false; skip_jvm_benchmark=true; api_key=8baa83ecddfe44b561fd3d92442e3319", "-C"};
